...
parser.add_argument(
    "--value1",
    default=6,
    help='Argument 0, input `value` for node "🔢 Length (Seconds)" id 28 (autogenerated)',
)
...
parser.add_argument(
    "--text30",
    default="Chinese man is walking in the temple alone.",
...
parser.add_argument(
    "--model64",
    default="Wan2_2-Animate-14B_fp8_e4m3fn_scaled_KJ.safetensors",
...
def main(*func_args, **func_kwargs):
    ...
    with torch.inference_mode(), ctx:
        ...
        floatconstant_28 = floatconstant.get_value(value=parse_arg(args.value1))

        intconstant = NODE_CLASS_MAPPINGS["INTConstant"]()
        intconstant_29 = intconstant.get_value(value=parse_arg(args.value2))

        primitivefloat = NODE_CLASS_MAPPINGS["PrimitiveFloat"]()
        primitivefloat_30 = primitivefloat.EXECUTE_NORMALIZED(
            value=parse_arg(args.value3)
        )

        intconstant_32 = intconstant.get_value(value=parse_arg(args.value4))

        loadimage = NODE_CLASS_MAPPINGS["LoadImage"]()
        loadimage_64 = loadimage.load_image(image=parse_arg(args.image5))
        ...
        wanvideoloraselectmulti_76 = wanvideoloraselectmulti.getlorapath(
            lora_0=parse_arg(args.lora_06),
            strength_0=parse_arg(args.strength_07),
            lora_1=parse_arg(args.lora_18),
            strength_1=parse_arg(args.strength_19),
            lora_2=parse_arg(args.lora_210),
            strength_2=parse_arg(args.strength_211),
            lora_3=parse_arg(args.lora_312),
            strength_3=parse_arg(args.strength_313),
            lora_4=parse_arg(args.lora_414),
            strength_4=parse_arg(args.strength_415),
            low_mem_load=False,
            merge_loras=False,
        )
        ...
        wanvideoblockswap_78 = wanvideoblockswap.setargs(
            blocks_to_swap=parse_arg(args.blocks_to_swap16),
            offload_img_emb=parse_arg(args.offload_img_emb17),
            offload_txt_emb=parse_arg(args.offload_txt_emb18),
        ...
        wanvideotorchcompilesettings_82 = wanvideotorchcompilesettings.set_args(
            backend=parse_arg(args.backend21),
            fullgraph=parse_arg(args.fullgraph22),
            mode=parse_arg(args.mode23),
            dynamic=parse_arg(args.dynamic24),
            dynamo_cache_size_limit=parse_arg(args.dynamo_cache_size_limit25),
            compile_transformer_blocks_only=parse_arg(
                args.compile_transformer_blocks_only26
            ),
        ...
        intconstant_161 = intconstant.get_value(value=parse_arg(args.value31))
        ...
        for q in range(args.queue_size):
            mathexpressionpysssss_21 = mathexpressionpysssss.evaluate(
                expression=parse_arg(args.expression32),
            ...
            vhs_loadvideo_13 = vhs_loadvideo.load_video(
                ...
                custom_width=parse_arg(args.custom_width34),
                custom_height=parse_arg(args.custom_height35),
            ...
            imageresizekjv2_33 = imageresizekjv2.resize(
                ...
                height=parse_arg(args.height38),
                upscale_method=parse_arg(args.upscale_method39),
                keep_proportion=parse_arg(args.keep_proportion40),
                pad_color=parse_arg(args.pad_color41),
                crop_position=parse_arg(args.crop_position42),
                divisible_by=parse_arg(args.divisible_by43),
                device="cpu",
                per_batch=0,
                image=get_value_at_index(vhs_loadvideo_13, 0),
                unique_id=6492057914019727386,
            )

            generateframesbycount_9 = generateframesbycount.r(
                frame_count=parse_arg(args.frame_count44),
                revert=parse_arg(args.revert45),
            ...
            imageresizekjv2_63 = imageresizekjv2.resize(
                ...
                height=parse_arg(args.height46),
                upscale_method=parse_arg(args.upscale_method47),
                keep_proportion=parse_arg(args.keep_proportion48),
                pad_color=parse_arg(args.pad_color49),
                crop_position=parse_arg(args.crop_position50),
                divisible_by=parse_arg(args.divisible_by51),
                device="cpu",
                per_batch=0,
                image=get_value_at_index(loadimage_64, 0),
                unique_id=15313537819843287287,
            )

            easy_showanything_20 = easy_showanything.log_input(
                text="97", anything=[get_value_at_index(vhs_loadvideo_13, 1)]
            )
            ...
            pixelperfectresolution_58 = pixelperfectresolution.execute(
                ...
                resize_mode=parse_arg(args.resize_mode52),
            ...
            vhs_videocombine_52 = vhs_videocombine.combine_video(
                frame_rate=parse_arg(args.frame_rate53),
                loop_count=parse_arg(args.loop_count54),
                filename_prefix=parse_arg(args.filename_prefix55),
                format=parse_arg(args.format56),
                pix_fmt="yuv420p",
                crf=19,
                save_metadata=True,
                trim_to_audio=False,
                pingpong=parse_arg(args.pingpong57),
                save_output=parse_arg(args.save_output58),
                images=get_value_at_index(dwpreprocessor_53, 0),
            )

            facemaskfromposekeypoints_198 = facemaskfromposekeypoints.createmask(
                person_index=parse_arg(args.person_index59),
                pose_kps=get_value_at_index(dwpreprocessor_53, 1),
            )

            imagecropbymaskandresize_56 = imagecropbymaskandresize.crop(
                base_resolution=parse_arg(args.base_resolution60),
                padding=parse_arg(args.padding61),
                min_crop_resolution=parse_arg(args.min_crop_resolution62),
                max_crop_resolution=parse_arg(args.max_crop_resolution63),
                image=get_value_at_index(imageresizekjv2_33, 0),
                mask=get_value_at_index(facemaskfromposekeypoints_198, 0),
            )

            wanvideomodelloader_75 = wanvideomodelloader.loadmodel(
                model=parse_arg(args.model64),
                base_precision=parse_arg(args.base_precision65),
                quantization=parse_arg(args.quantization66),
                load_device=parse_arg(args.load_device67),
            ...
            wanvideoclipvisionencode_87 = wanvideoclipvisionencode.process(
                strength_1=parse_arg(args.strength_168),
                strength_2=parse_arg(args.strength_269),
                crop=parse_arg(args.crop70),
                combine_embeds=parse_arg(args.combine_embeds71),
                force_offload=parse_arg(args.force_offload72),
                tiles=0,
                ratio=0.5,
            ...
            mathexpressionpysssss_144 = mathexpressionpysssss.evaluate(
                expression=parse_arg(args.expression73),
            ...
            wanvideoanimateembeds_88 = wanvideoanimateembeds.process(
                ...
                force_offload=parse_arg(args.force_offload74),
                frame_window_size=get_value_at_index(mathexpressionpysssss_144, 0),
                colormatch=parse_arg(args.colormatch75),
                pose_strength=parse_arg(args.pose_strength76),
                face_strength=parse_arg(args.face_strength77),
                tiled_vae=False,
            ...
            wanvideosampler_90 = wanvideosampler.process(
                steps=parse_arg(args.steps78),
                cfg=parse_arg(args.cfg79),
                shift=parse_arg(args.shift80),
                seed=parse_arg(args.seed81),
                force_offload=parse_arg(args.force_offload82),
                scheduler=parse_arg(args.scheduler83),
                riflex_freq_index=parse_arg(args.riflex_freq_index84),
                denoise_strength=1,
                batched_cfg="",
                rope_function="comfy",
                start_step=0,
            ...
            wanvideodecode_91 = wanvideodecode.decode(
                enable_vae_tiling=parse_arg(args.enable_vae_tiling85),
                tile_x=parse_arg(args.tile_x86),
                tile_y=parse_arg(args.tile_y87),
                tile_stride_x=parse_arg(args.tile_stride_x88),
                tile_stride_y=parse_arg(args.tile_stride_y89),
            ...
            vhs_videocombine_106 = vhs_videocombine.combine_video(
                ...
                loop_count=parse_arg(args.loop_count90),
                filename_prefix=parse_arg(args.filename_prefix91),
                format=parse_arg(args.format92),
                pix_fmt="yuv420p",
                crf=19,
                save_metadata=True,
                trim_to_audio=False,
                pingpong=parse_arg(args.pingpong93),
                save_output=parse_arg(args.save_output94),
            ...
            vhs_videocombine_141 = vhs_videocombine.combine_video(
                frame_rate=parse_arg(args.frame_rate95),
            ...
            easy_showanything_147 = easy_showanything.log_input(
                text="97", anything=[get_value_at_index(mathexpressionpysssss_144, 0)]
            )

            easy_showanything_148 = easy_showanything.log_input(
                text="97", anything=[get_value_at_index(mathexpressionpysssss_21, 0)]
            )
            ...
            vhs_videocombine_178 = vhs_videocombine.combine_video(
                ...
                loop_count=parse_arg(args.loop_count106),
                filename_prefix=parse_arg(args.filename_prefix107),
                format=parse_arg(args.format108),
                pix_fmt="yuv420p",
                crf=19,
                save_metadata=True,
                trim_to_audio=False,
                pingpong=parse_arg(args.pingpong109),
                save_output=parse_arg(args.save_output110),
