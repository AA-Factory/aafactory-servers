...
from infinite_talk.InfiniteTalk.src.vram_management import AutoWrappedQLinear, AutoWrappedLinear, AutoWrappedModule, enable_vram_management
from infinite_talk.InfiniteTalk.wan.utils.utils import convert_video_to_h264, extract_specific_frames, get_video_codec
from infinite_talk.InfiniteTalk.wan.wan_lora import WanLoraWrapper
...
class InfiniteTalkPipeline:
    ...
    def generate_infinitetalk(self,
        ...
        bucket_config_module = importlib.import_module("infinite_talk.InfiniteTalk.wan.utils.multitalk_utils")
